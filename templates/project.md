...
- Side-effectful proof runs require review state `approved_for_sandbox`.
- Production execution requires review state `approved_for_production` and approved credential bindings.
