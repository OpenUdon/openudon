# M28 Ambiguous Source Negative

## Goal

M28 negative sample: stop and render a local gap report when an ambiguous provider action lacks usable API source evidence.
