...
- **Review evidence** is the human-readable side-effect, risk, credential, and trusted-runner
  package summary.
- **Review handoff** is an `apitools.review-handoff.v1` manifest with OpenUdon package inputs,
...
- Optional Symphony workflow prompt/config policy for OpenUdon-managed work items.
