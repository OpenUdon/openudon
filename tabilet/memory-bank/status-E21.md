...
**State:** Active; E21.1 is in progress. Synthetic local qualification only.
...
| Item | State | Notes |
| --- | --- | --- |
| E21.1 Freeze M86 current-lock meaning | `[+]` | Copied the exact pre-E21 scenario lock bytes (SHA-256 `57ebe6c70bc0b1e810ed4fb490f36ecb227c47f362bb738b56680ce7abcd6a77`) and integration lock bytes (`9eec17f1489e1c805e2d2bfb8b89a439ee7153d5c49ec09a3ee903ce6761d393`) into versioned v2 snapshots and routed the M86 readers to them. Focused scenario/integration tests pass. M86 integration/loopback/journey reports independently verify at 19/19, 23/23 and 11/11 with their recorded digests unchanged. Current lock advance remains E21.2. |
| E21.2 Pin and emit the repaired current stack | `[ ]` | Select clean Udon `6d32d4967469c579d35adcf47eaddb76a225dbae`; add a separate sorted, clean, exact 14-repository Udon local-replacement closure; emit and verify v3 scenario, journey and integration reports. Preserve historical default and v2 lock/report meaning. |
| E21.3 Extend native current-stack qualification | `[ ]` | Add explicit stack selection to native qualification with historical as the default. Emit v3 for current stack; route scenario, build-input, BAP and BRP stages through the same current locks and closure. Keep v1/v2 readers unchanged. |
