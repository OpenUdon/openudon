...
| M85.2 | `[~]` | At clean committed revisions, run and verify the full provider-free matrix, record exact report/digest and component commits, run owner checks, then close bounded review with no open P1/P2. |
